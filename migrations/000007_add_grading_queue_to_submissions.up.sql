...
-- the same statement.
ALTER TABLE submissions ADD COLUMN attempts        INT          NOT NULL DEFAULT 0 AFTER status;
ALTER TABLE submissions ADD COLUMN last_error      VARCHAR(500) NULL               AFTER attempts;
ALTER TABLE submissions ADD COLUMN next_attempt_at DATETIME(3)  NULL               AFTER last_error;
ALTER TABLE submissions ADD COLUMN claimed_at      DATETIME(3)  NULL               AFTER next_attempt_at;
